  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-md p-6">
        ...
        <p className="mb-4 text-sm text-gray-600">This will create your organization and set you as Admin.</p>
        <div className="mb-4">
          <label className="mb-1 block text-sm" htmlFor="orgname">Organization name</label>
          <input id="orgname" className="w-full rounded border p-2" value={name} onChange={(e) => setName(e.target.value)} />
        </div>
        <button
